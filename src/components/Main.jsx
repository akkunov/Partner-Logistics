                 ...
                 height={'100vh'}>
                    <div ref={mainContentRef}
                        ...
                        <div className={'card-description'}>
                            ...
                            <div>
                                <svg width='400' height="400" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={'img'}>
                                    <g clip-path="url(#clip0_234_943)" style={{width:"300px"}}>
                                        <path  width ="300px" fill-rule="evenodd" clip-rule="evenodd" d="M200 50V4.37114e-06L100 0V49.9803C99.9893 22.3751 77.6077 4.37114e-06 50 4.37114e-06H2.18557e-06V100H50C22.3858 100 -1.20706e-06 122.386 0 150L2.18557e-06 200H100L100 150C100 177.614 122.386 200 150 200H200L200 100H150.02C177.625 99.9893 200 77.6077 200 50Z" fill="url(#paint0_linear_234_943)"/>
                                    </g>
                                    <defs>
