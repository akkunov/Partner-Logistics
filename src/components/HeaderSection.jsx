...
import '../styles/HeaderSectoin.css'

export const HeaderSection = (props) => {

    const {handlePricingClick,handleHeaderClick,handleMainCick,handleFooterClick, headeRef} = props


    const bgImage2 = `#457B9D`
    return (

        <Section bgColor={bgImage2}
                 width={'100vm'}
                 height={'100vh'}
        >
            <Header handlePricingClick={handlePricingClick}
                    handleHeaderClick={handleHeaderClick}
                    handleMainCick={handleMainCick}
            ...
            <div>
                <div className={'wrapper'}>
                    ...
                    <svg  width="500" height="500" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_105_723" x1="100" y1="17" x2="100" y2="183"
                                            gradientUnits="userSpaceOnUse">
